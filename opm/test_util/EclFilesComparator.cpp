...
void RegressionTest::boolComparisonForOccurrence(const std::string& keyword, int occurrence1, int occurrence2) const {
...
void IntegrationTest::results() {
    for (const auto& it : keywordWhitelist) resultsForKeyword(it);
}
