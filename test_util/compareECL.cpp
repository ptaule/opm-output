...
int main(int argc, char** argv) {
    ...
    if (specificFileType) {
        ...
        if (fileTypeString.compare("UNRST")) {} //Do nothing
        else if (fileTypeString.compare("RST") == 0) {
            concatenateRestart(basename1);
            concatenateRestart(basename2);
        }
        else if (fileTypeString.compare("RST1") == 0) {
            concatenateRestart(basename1);
        }
        else if (fileTypeString.compare("RST2") == 0) {
            concatenateRestart(basename2);
        }
        else if (fileTypeString.compare("INIT") == 0) {
            file_type = ECL_INIT_FILE;
        }
        else if (fileTypeString.compare("RFT") == 0) {
